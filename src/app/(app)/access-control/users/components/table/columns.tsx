    ...
    header: () => <div className="w-full flex items-center"><p className="hidden sm:table-cell text-center">Super</p></div>,
     cell: ({ row }) => {
      return row.original.isSuperAdmin
        ? <Badge className="mx-auto">SuperAdmin</Badge>
...
return <div className="w-full">
    {
      status  ? <span className="w-2.5 h-2.5 bg-emerald-500 rounded-full flex mx-auto" />
        : <span className="w-4 h-4 bg-red-500 rounded-full flex mx-auto" />
