    ...
    <>
      ...
      <div className="flex items-center justify-between p-4 lg:p-8">
        <div>
          ...
          <p className='text-md text-muted-foreground'>Todos usuarios que tenhem acesso ao <b>Tecno Bantu</b></p>
        </div>
        <Form />
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-10 px-4 lg:px-8">
        <Card className="bg-transparent flex justify-between items-center p-4 rounded-md col-span-3">
          ...
          width={45} 
          height={45} 
          alt="tecno_bantu logo" className="grid h-12 w-12 bg-card rounded-sm text-center items-center" src="/Tcn_Bantu_Modelo.png"/>
        </Card>
        {/* <Card className="bg-transparent flex justify-between items-center p-4 rounded-md col-span-3">
