...
const { user }=await getMember(params.id)
  return (
    <div className="flex-col flex md:flex-row w-full">
      <UserContent name={user.name} email={user.email} avatar={user.avatar} isSuperAdmin={user.isSuperAdmin}/>
