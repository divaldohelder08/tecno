"use client"
import { Eye, Loader2, MoreVertical, Trash, Copy, CircleDashed, FilePenIcon, User, TrashIcon, FilePen, FileKey2, Lock, ScanBarcode } from "lucide-react";
...
import { deleteArticleSerice } from "@/http/article";
...
import { AddBarCodeForm } from "./add-barcode";
  ...
  return (
    <>
      ...
      <DeleteAlert
        id={id}
        title={name}
        deleteFunction={deleteArticleSerice}
